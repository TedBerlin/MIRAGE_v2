...
class RAGEngine:
    ...
    def __init__(
        ...
        # Ensure initial ingestion if documents exist and no embeddings are present
        if not self.embedding_manager.get_collection_stats().get("total_documents"):
            logger.info("No documents in collection, starting automatic ingestion")
