"""
Alternative embedding management module for MIRAGE v2.

Uses OpenAI embeddings instead of sentence-transformers to avoid segmentation fault.
"""
...
class AlternativeEmbeddingManager:
    """Manages vector embeddings with QDrant storage using OpenAI embeddings."""
    ...
    def __init__(
        ...
        logger.info(
            "AlternativeEmbeddingManager initialized",
            model=model_name,
            db_path=db_path,
        ...
        try:
            ...
            try:
                ...
                if collection_exists:
                    ...
                    # Create collection with OpenAI embedding dimension (1536 for text-embedding-3-small)
