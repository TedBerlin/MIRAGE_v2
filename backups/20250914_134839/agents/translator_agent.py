...
class TranslatorAgent:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        logger.info("TranslatorAgent initialized", model="gemini-pro", supported_languages=list(self.supported_languages.keys()))
    ...
    def translate_response(
        ...
        try:
            ...
            translation_response = self.model.generate_content(user_prompt)
