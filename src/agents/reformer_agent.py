...
class ReformerAgent:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        logger.info("ReformerAgent initialized", model="gemini-1.5-flash")
    ...
    def reform_response(
        ...
        try:
            ...
            # Format the prompts
            system_prompt = self.prompts.get_prompt("reformer", "system_prompt")
            ...
            if detected_language == "fr":
                user_prompt += "\n\nIMPORTANT: Améliorez la réponse en français. Maintenez la terminologie médicale française."
            elif detected_language == "es":
                user_prompt += "\n\nIMPORTANT: Mejore la respuesta en español. Mantenga la terminología médica española."
            elif detected_language == "de":
                user_prompt += "\n\nIMPORTANT: Verbessern Sie die Antwort auf Deutsch. Behalten Sie die deutsche medizinische Terminologie bei."
            
            # Generate refined response with both system and user prompts
            reform_response = self.model.generate_content([system_prompt, user_prompt])
